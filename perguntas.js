export const perguntas =  [
    {
        enunciado: "De que maneira podemos abordar as discriminações de classe propagadas nas redes de comunicação e ainda, podendo abranger resoluções frugais no intuito de enaltecer essas comunidades?De que maneira podemos abordar as discriminações de classe propagadas nas redes de comunicação e ainda, podendo abranger resoluções frugais no intuito de enaltecer essas comunidades?",
        alternativas: [
            {
            ...
            {
                texto: "Abrangendo novos orizontes de ideias",
                afirmacao: [
                    "É possível, já que há inúmeros acessos e diversas compreensões do que é passado e pode ajudar muitas comunidades com simplicidade e inovação",
                   "Complexo, já que na atualidade existem vários outros dilemas além da preocupação ambiental"
                ],
                proxima: 2,
            },
        ]
